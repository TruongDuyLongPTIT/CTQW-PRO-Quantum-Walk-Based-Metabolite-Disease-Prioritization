...
import numpy as np
from config import CACHE_DIR, T_CTQW, RECON3D_CURRENCY_METABOLITE
...
_ctqw_o_fn  = lambda seeds: run_ctqw_o(seeds, T_CTQW)
_ctqw_c_fn  = lambda seeds: run_ctqw_c(seeds, T_CTQW)
