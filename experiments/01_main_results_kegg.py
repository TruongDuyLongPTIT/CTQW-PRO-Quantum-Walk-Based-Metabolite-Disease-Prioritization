...
from config import CACHE_DIR, T_CTQW, NH_GAMMA_KEGG, KEGG_CURRENCY_METABOLITE
...
run_nh = make_nh_pro(
    ...
    KEGG_CURRENCY_METABOLITE, pro_nodes, NH_GAMMA_KEGG, T_CTQW)
...
print('\n' + '='*72)
print('TABLE 1: RWR vs CTQW (G_cc, KEGG)')
_print_full_and_dedup(all_t1, ['RWR', 'CTQW'])

print('\n' + '='*72)
print('TABLE 2: PROFANCY vs CTQW-PRO (G_pro, KEGG)')
